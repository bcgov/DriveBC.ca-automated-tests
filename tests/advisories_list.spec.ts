...
test('test', async ({ page }) => {
  ...
  await expect(page.locator('p').filter({ hasText: 'This is a beta version of' }).locator('svg')).toBeVisible();
  await expect(page.locator('#root')).toContainText('This is a beta version of DriveBC.');
